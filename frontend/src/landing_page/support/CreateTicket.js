    ...
    return (  
        <div className='container'>
           ...
           <div className='col-4 p-5 mt-2 mb-2'>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
               <h4> <i class="fa fa-user"></i>Your Zerodha Account</h4>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
               <h4> <i class="fa fa-user-circle"></i>Kite</h4>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
               <h4> <i class="fa fa-inr"></i> Funds</h4>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
               <h4> <i class="fa fa-dashboard"></i>Console</h4>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
               <h4> <i class="fa fa-pie-chart"></i>coin</h4>
